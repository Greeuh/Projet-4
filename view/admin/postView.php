...
<body class="whitebg">
        ...
        <section class="container">
            <h2 class="text-center my-5"><?= strip_tags($post['title']) ?></h2>
            <div class="mb-5">
                <?= nl2br(($post['content'])) ?>
            </div>
            <div class="my-3 text-muted w-100 d-flex justify-content-between">
        ...
        <div class="container comment-block mt-5" id="comments">
