            ...
            <div class="container d-flex justify-content-center mx-auto my-4 w-75">
                <div class="d-flex justify-content-between align-self-start">
                    <div id="img-author" class="d-inline-block m-auto p-auto">
                        <img src="https://www.antoineparriaud.fr/images/jean_forteroche2.jpg" alt="Photo de Jean Forteroche" class="w-75 d-inline-block">
                    </div>
                ...
                <p class="text-center align-self-end m-auto p-auto" id="infos-author-2">Morbi vestibulum nulla in augue, nec faucibus libero eleifend. Praesent faucibus ante eget eros auctor, ut pretium purus. Nullam vehicula augue diam.</p>
            </div>
            <div class="grey-line-separator"></div>
        </div>
                    ...
                    <ul class="user_comment">
                        ...
                        <div class="d-flex comment_toolbar">
                            <div class="comment_details w-75">
                                <ul class="text-muted">
                                    <li id="comment-hour"><i class="fa fa-clock-o"></i> <?= $comment['comment_date_hr'] ?></li>
